...
if (!sqliteFile) {
  throw new Error(
    "No local D1 SQLite file was found under apps/backend-cloudflare/.wrangler/state. Run pnpm --filter backend-cloudflare db:migrate once, then try db:studio again.",
  );
}
